...
const services = () => {
    return (
        <div id='services' className='w-full px-[12%] py-10 scroll-mt-20'>
            ...
            <div className='w-full grid grid-cols-auto sm:grid-cols-2 lg:grid-cols-4 gap-10 '>
                {Services.map(({ icon, title, description, link}, index) => (
                    
                    <div key={index} className='flex flex-col items-center gap-3 border border-gray-400 rounded-lg px-8 py-12 hover:shadow-black cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500'>
